...
function confirmProductDelete() {
  ...
  updateStats();
  closeProductDelete();
  // Jangan hardcode success pada optimistic UI.
  // Backend akan mengirim flash message melalui redirect agar warna/judul sesuai.
}
...
function exportLaporanProduk() {
  ...
  window.open(
    `../../export_laporan_produk.php?status=${status}&jenis=${jenis}`,
    "_blank",
  );
}
